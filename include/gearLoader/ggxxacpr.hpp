...
namespace ggxxacpr {
    ...
    enum class JobMode : uint32_t {
        ...
        CHAR_MENU = JOB_MODE_CHAR_MENU,
        GAME_INIT = JOB_MODE_GAME_INIT,
        BATTLE = JOB_MODE_BATTLE,
        DEMO = JOB_MODE_DEMO,
        TITLE_MAIN = JOB_MODE_TITLE_MAIN,
        MENUS = JOB_MODE_MENUS,
        DEBUG = JOB_MODE_DEBUG, // The debug menu function is not assigned by default, setting the job mode to this without proper setup will result in a crash.
        ...
        DEBUG_RESTART = JOB_MODE_DEBUG_RESTART,
        DEBUG_TRAINING = JOB_MODE_DEBUG_TRAINING,
        DEBUG_VERSUS_SCREEN = JOB_MODE_DEBUG_VERSUS_SCREEN,
        DEBUG_STAGE_SELECT = JOB_MODE_DEBUG_STAGE_SELECT,
        DEBUG_PROFILE = JOB_MODE_DEBUG_PROFILE,
        DEBUG_WIN_SCREEN = JOB_MODE_DEBUG_WIN_SCREEN,
        DEBUG_STORY_ENDING = JOB_MODE_DEBUG_STORY_ENDING,
        DEBUG_SOUND_MENU = JOB_MODE_DEBUG_SOUND_MENU,
        MISSION_MENU = JOB_MODE_MISSION_MENU,
        MISSION_SELECT = JOB_MODE_MISSION_SELECT,
        MISSION_RETRY = JOB_MODE_MISSION_RETRY,
