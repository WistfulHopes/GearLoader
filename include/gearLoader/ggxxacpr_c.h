...
enum GGXXACPR_JobMode {
    ...
    JOB_MODE_CHAR_MENU = 0x4,
    JOB_MODE_GAME_INIT = 0x5,
    JOB_MODE_BATTLE = 0x6,
    JOB_MODE_DEMO = 0x7,
    JOB_MODE_TITLE_MAIN = 0x9,
    JOB_MODE_MENUS = 0xA,
    JOB_MODE_DEBUG = 0xC, // The debug menu function is not assigned by default, setting the job mode to this without proper setup will result in a crash.
    ...
    JOB_MODE_DEBUG_RESTART = 0x1A,
    JOB_MODE_DEBUG_TRAINING = 0x1B,
    JOB_MODE_DEBUG_VERSUS_SCREEN = 0x1C,
    JOB_MODE_DEBUG_STAGE_SELECT = 0x1D,
    JOB_MODE_DEBUG_PROFILE = 0x1E,
    JOB_MODE_DEBUG_WIN_SCREEN = 0x1F,
    JOB_MODE_DEBUG_STORY_ENDING = 0x20,
    JOB_MODE_DEBUG_SOUND_MENU = 0x21,
    JOB_MODE_MISSION_MENU = 0x24,
    JOB_MODE_MISSION_SELECT = 0x25,
    JOB_MODE_MISSION_RETRY = 0x26,
